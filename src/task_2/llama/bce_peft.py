...
# === EXPERIMENTS CONFIG ===
experiments = {
    "standard_32": ["meta-llama/Meta-Llama-3-8B", 32, "llama_standard_multi_label_32", "standard"],
    "standard_42": ["meta-llama/Meta-Llama-3-8B", 42, "llama_standard_multi_label_42", "standard"],
    "standard_52": ["meta-llama/Meta-Llama-3-8B", 52, "llama_standard_multi_label_52", "standard"],
    "cpt_32": ["TrustHLT-ECALP/llama-3.1-8b-cpt-full", 32, "llama_cpt_multi_label_32", "cpt"],
    "cpt_42": ["TrustHLT-ECALP/llama-3.1-8b-cpt-full", 42, "llama_cpt_multi_label_42", "cpt"],
    "cpt_52": ["TrustHLT-ECALP/llama-3.1-8b-cpt-full", 52, "llama_cpt_multi_label_52", "cpt"],
}
...
for exp_name, (model_path, seed, output_dir, model_type) in experiments.items():
    ...
    class MultiLabelTrainer(Trainer):
        def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
            ...
            loss_fct = torch.nn.BCEWithLogitsLoss(pos_weight=class_weights, reduction='none')
